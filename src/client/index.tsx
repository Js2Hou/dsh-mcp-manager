 ...
 * add/remove, enable/disable and connection-status tools. All data flows over
 * the loopback-only `/mcp-manager` Connection RPC channel registered by the
 * node half; the browser never touches the host filesystem directly.
 *
...
/** Required services: the slot registry and the connection RPC. */
...
/**
 * Client plugin body: register the settings section and inject the stylesheet.
