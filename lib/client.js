window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  statusActiveNoTools: "\u6D3B\u52A8 \xB7 0 \u4E2A\u5DE5\u5177",
		  statusFailed: "\u5931\u8D25",
		  statusDisabled: "\u5DF2\u505C\u7528",
		  statusLoading: "\u52A0\u8F7D\u4E2D",
		  statusPending: "\u7B49\u5F85\u4E2D",
		...
		var en = {
		  ...
		  statusActiveNoTools: "Active \xB7 0 tools",
		  statusFailed: "Failed",
		...
		function statusOf(server) {
		  ...
		  switch (server.fiberPhase) {
		    case "active":
		      return server.toolCount > 0 ? { tone: "ok", key: "statusConnected", count: String(server.toolCount) } : { tone: "ok", key: "statusActiveNoTools" };
		    case "failed":
